...
- [Open fs-agent the first time](#open-fs-agent-the-first-time)
  ...
  - [Open fs-agent with Vscode](#open-fs-agent-with-vscode)
...
```bash
git clone https://github.com/rljson/fs-agent.git
```
